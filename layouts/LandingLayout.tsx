...
export default function LandingLayout({children, title}: LandingProps) {
    ...
    <>
        <LandingNavigation/>
        <header className='relative h-screen bg-fixed bg-cover bg-mnt bg-bottom w-full flex flex-col items-center justify-around'>
            ...
            <div className='overlay absolute w-full h-full bg-gradient-to-r to-theme-primary-600 from-theme-primary-900 z-10 mix-blend-soft-light'></div>
